...
export class WebXREngine {
  constructor({ mountEl, statusEl, overlayEl, videoEl, gift }) {
  ...
  updateTransform(action) {
    ...
    this.applyPlacement();
    this.setStatus(
      `Visible placement tuned. Height ${this.heightOffset.toFixed(1)}m · forward ${this.forwardDistance.toFixed(1)}m · scale ${this.baseScale.toFixed(2)}x.`,
      'success'
    );
  }
